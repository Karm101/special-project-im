    ...
    <div className="public-page drms-root">
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          <div style={{ fontSize: 26, fontWeight: 800, color: '#001C43', fontFamily: "'Montserrat', sans-serif" }}>What would you like to do?</div>
          <div style={{ fontSize: 14, color: '#B1B1B1', marginTop: 6, lineHeight: 1.6, fontFamily: "'Montserrat', sans-serif" }}>Select an option below to get started.</div>
        </div>
        ...
        <div className="landing-grid">
          <div className="landing-card" onClick={() => router.push('/student/submit')}>
            ...
            <button className="btn-primary" style={{ padding: '10px 24px', marginTop: 4 }} onClick={e => { e.stopPropagation(); router.push('/student/submit'); }}>Get Started →</button>
          </div>
          ...
          <div className="landing-card" onClick={() => router.push('/student/track')}>
            ...
            <button className="btn-outline" style={{ padding: '10px 24px', marginTop: 4 }} onClick={e => { e.stopPropagation(); router.push('/student/track'); }}>Track Now →</button>
          </div>
        </div>

        <div style={{ textAlign: 'center', marginTop: 28 }}>
          <div style={{ fontSize: 12, color: '#B1B1B1', fontFamily: "'Montserrat', sans-serif" }}>Alumni, transferees, or authorized representatives?</div>
          <span style={{ fontSize: 12, color: '#114B9F', cursor: 'pointer', fontWeight: 600, fontFamily: "'Montserrat', sans-serif" }} onClick={() => router.push('/student/submit')}>
